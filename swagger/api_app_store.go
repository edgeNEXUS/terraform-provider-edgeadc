...
/*
AppStoreApiService Licence Details
...
@return AppData
*/
func (a *AppStoreApiService) GET39pageAppstoreGet(ctx context.Context) (AppData, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue AppData
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/GET/39?page=Appstore"
...
@return AppData69Get
*/
func (a *AppStoreApiService) GET63Get(ctx context.Context) (AppData69Get, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue AppData69Get
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/GET/63"
