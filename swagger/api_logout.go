...
@return JetLogoutResp
*/
func (a *LogoutApiService) GET35Get(ctx context.Context) (JetLogoutResp, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue JetLogoutResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/GET/35"
